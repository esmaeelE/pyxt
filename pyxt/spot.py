...
class Spot:
  ...
  "items": [
    ...
    def get_support_withdraw(self):
        res = self.req_get('/v4/public/wallet/support/currency')
        return res['result']

    def withdraw(self, currency, chain, amount, address, client_order_id=None, memo=None, to_account_id=None):
        """
        :param
        :return:
        """
        ...
        if memo:
            params['memo'] = memo
        if to_account_id:
            params["toAccountId"] = to_account_id
